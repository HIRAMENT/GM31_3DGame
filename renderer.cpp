...
void Renderer::Init()
{
	...
	// デバイス、スワップチェーン作成
	// デバイス … DXを制御する大本のもの
	// スワップチェーン … バックバッファとフロントバッファの切り替えをするもの
	...
	// ラスタライザステート設定
	// ラスタライザステート … 塗りつぶし、ワイヤーフレームなどの設定に使う
	...
	// デプスステンシルステート設定
	// デプスステンシルステート … 震度バッファに対する書き込みの設定
...
{
	// いらなくなったらReleaseを呼ぶ
	//  動的メモリ確保でいうところのdeleteのようなもの
	// compoint(コムポインタ) を使うと呼ばなくても自動的にやってくれるらしい
